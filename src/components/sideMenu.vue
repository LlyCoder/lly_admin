<template>
    <aside class="main-sidebar animated" :class="{ showSlide: sidebar.show, hideSlide: !sidebar.show, expandSide:(!sidebar.collapsed||device.isMobile)}">
        <el-scrollbar tag="div" warpClass="vue-scrollbar" v-if="(!sidebar.collapsed||device.isMobile)">
            <div class="sidebar">
                <el-menu :default-active="onRoutes"
                         :default-openeds="onRouteKeys"
                         class="el-menu-style"
                         :collapse="sidebar.collapsed&&!device.isMobile"  router @select="handelSelect">
        ...
        <div class="sidebar" v-else>
            <el-menu :default-active="onRoutes"
                     class="el-menu-style"
                     router :collapse="sidebar.collapsed&&!device.isMobile" @select="handelSelect">
                <template v-for="item in menuList">
                    <sub-menu :param="item"></sub-menu>
                </template>
            </el-menu>
